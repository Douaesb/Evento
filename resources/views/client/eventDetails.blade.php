                        ...
                        @if ($placesLeft > 0)
                            <div class="flex items-center mt-3">
                                <div class="flex items-center p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                                    ...
                                    <div>
                                        <span class="font-medium">Only</span> {{ $event->places }}
                                        ...
                                        @else
                                            <div class="flex gap-2">
                                                <form
                                                    ...
                                                    @else
                                                        <span
                                                            class="ml-4 bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400">No
                                                            places left</span>
                                                    @endif
                                                </form>
                                            </div>
